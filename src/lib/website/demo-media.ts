export const DEMO_MEDIA_ASSETS = {
  ...
  "club-logo": { file: "club-logo-circle.png", label: "Herb klubu" },
  "club-logo-circle": { file: "club-logo-circle.png", label: "Herb okrągły" },
  "club-logo-crest": { file: "club-logo-crest.png", label: "Herb tarcza" },
